...
class AlgoritmoGenetico:
        ...
        for index, (linea_base, linea_objetivo) in enumerate(zip(self.archivo.basex, self.archivo.filex)):
            ...
            for g in range(self.generaciones):
                ...
                while len(nueva_poblacion) < self.tam_poblacion:
                    ...
                    hijo1, hijo2 = self.cruzar_dos_puntos(padre1, padre2)
    ...
    def cruzar_dos_puntos(self, padre1, padre2):
        """
        Realiza cruza de dos puntos entre dos padres.
        
        Selecciona dos puntos de corte aleatorios y intercambia el segmento
        entre esos puntos entre los dos padres.
        
        Args:
            padre1: Lista de genes del primer padre
            padre2: Lista de genes del segundo padre
            
        Returns:
            Tupla con dos hijos resultantes de la cruza
        """
        longitud = len(padre1)
        
        # Si la longitud es muy pequeña, usar cruza de un punto
        if longitud <= 2:
        ...
        # Crear los hijos intercambiando el segmento entre los puntos
...
def main():
    print("=== Algoritmo Genético - Cruza de Dos Puntos ===")
    ...
    try:
        ...
        print(f"Ejecutando algoritmo con cruza de dos puntos:")
        print(f"Población={tam_poblacion}, Generaciones={generaciones}, Mutación={tasa_mutacion}")
